...
def main():
    ...
    bridge = OriginalBridgeInterface()

    result = bridge.execute("Original Bridge DryRun")
    ...
    report_file = report_dir / (
        f"original_bridge_completion_report_{datetime.now():%Y%m%d_%H%M%S}.json"
    )
    ...
    print("=== Original Bridge Completion Report ===")
