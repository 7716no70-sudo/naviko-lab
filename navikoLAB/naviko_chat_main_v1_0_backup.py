...
class Naviko:
    ...
    def get_startup_message(self):
        ...
        warmth = self.personality.get("warmth", 0.5)
        stability = self.personality.get("stability", 0.5)
        memory_count = len(self.short_memory)
    ...
    def save_state(self):
        ...
        self.save_json(MEMORY_DIR / "short_memory.json", self.short_memory)
...
class NavikoChatGUI:
    def __init__(self, root):
        ...
        self.root = root
        self.root.title("Naviko v1.0 - Chat Core")
        ...
        self.button = tk.Button(root, text="送信", command=self.send_message)
        self.button.pack(padx=10, pady=(0, 10))

        self.add_message("ナビ子", self.naviko.get_startup_message())
    ...
    def send_message(self, event=None):
        ...
        reply = self.naviko.chat(user_text)
