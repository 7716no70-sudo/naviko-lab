...
PHASE = "Phase32-3 Risk Classifier Completion Report"
...
def main() -> None:
    ...
    builder = latest("risk_classifier_*.json")
    diagnostics = latest("risk_classifier_diagnostics_*.json")
    ...
    report = {
        ...
        "RiskClassifierCompleted": completed,
        "RiskLevelClassificationReady": completed,
    ...
    save_path = workspace_dir() / f"risk_classifier_completion_report_{timestamp}.json"
    ...
    print("=== Risk Classifier Completion Report ===")
    ...
    print(f"RiskClassifierCompleted: {report['RiskClassifierCompleted']}")
    print(f"RiskLevelClassificationReady: {report['RiskLevelClassificationReady']}")
