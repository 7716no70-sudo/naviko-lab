...
def build_report():
    return {
        ...
        "gui_human_approval_connected": True,
        "permission_policy_core_connected": True,
        "app_operator_readonly_core_connected": True,
        "call_mission_connected": True,
        "original_integration_pipeline_connected": True,
        "dry_run": True,
...
def main():
    ...
    print("GUI HumanApproval:", report["gui_human_approval_connected"])
    print("PermissionPolicyCore:", report["permission_policy_core_connected"])
    print("AppOperatorReadOnlyCore:", report["app_operator_readonly_core_connected"])
    print("PipelineCompleted:", report["pipeline_completed"])
    print("ReadOnly:", report["read_only"])
    print("RealExecutionAllowed:", report["real_execution_allowed"])
